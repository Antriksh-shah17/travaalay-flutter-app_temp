...
class _TranslatorProfilePageState extends State<TranslatorProfilePage> {
  ...
  /// Fetch the latest user profile from the DB to check if the Admin approved them
  Future<void> _fetchLatestStatus() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Safely handle both Object {} and Array [{}] responses from MySQL backend
        ...
        if (mounted) {
          setState(() {
            // If the API confirms the user is verified, update the status.
            if (isVerified) {
              verificationStatus = "Verified ✅";
            } 
            // If not verified (e.g., new user or admin rejected), reset to the base state.
            else {
        ...
        child: CustomScrollView(
          ...
          slivers: [
            SliverAppBar(
              ...
              title: const Text("Translator Profile"),
                        ...
                        children: [
                          ...
                          if (!isVerified) ...[
                            ...
                            _buildActionTile(
                              ...
                              subtitle: "Language or Guide Certifications",
                      ...
                      child: Column(
                        children: [
                          _buildActionTile(
                            ...
                            title: "Edit Profile",
                            subtitle: "Update your details and languages",
                            accent: AppColors.accent,
                            onTap: () {
